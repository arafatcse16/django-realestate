        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "city",
                    models.CharField(
                        default="Dhaka", max_length=100, verbose_name="City"
                    ),
                ),
                (
                    "postal_code",
                    models.CharField(
                        default="1212", max_length=180, verbose_name="Postal Code"
                    ),
                ),
                (
                    "street_address",
                    models.CharField(
                        default="Dhaka", max_length=255, verbose_name="Street Address"
                    ),
                ),
                (
                    "property_number",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        verbose_name="Agent, Seller, Buyer",
                    ),
                ),
            ],
            options={
